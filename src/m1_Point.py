...
class Point(object):
    ...
    def move_to(self, x2, y2):
        self.newstartx = self.x
        self.newstarty = self.y
        self.x = x2
        self.y = y2
        self.moves = self.moves  + 1
        self.total = self.total + math.sqrt((self.x - self.newstartx)**2 + (self.y - self.newstarty)**2)
    ...
    def halfway_to(self, p2):
        self.halfx = ((self.x - p2.x) / 2) + p2.x
        self.halfy = ((self.y - p2.y) / 2) + p2.y
